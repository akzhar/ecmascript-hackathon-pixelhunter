var statsMoreView = (function () {
  'use strict';

  var statsMoreView = `<div id="main" class="central__content">
  <header class="header">
    <button class="back">
